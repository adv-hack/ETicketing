...
set @body = (convert(nvarchar(max),(select top 1 CONTROL_CONTENT from tbl_control_text_lang where CONTROL_CODE = 'TalentEmail.vb' and TEXT_CODE = 'AmendPPSEmailBody')))
