...
set @subject = Isnull((select top 1 CONTROL_CONTENT from tbl_control_text_lang where CONTROL_CODE = 'OrderConfirmEmail.vb' and TEXT_CODE = 'EmailSubjectTicketingTransfer'),'')
set @body =     ((convert(nvarchar(max),isnull((select top 1 CONTROL_CONTENT from tbl_control_text_lang where CONTROL_CODE = 'TicketingTransfer.vb' and TEXT_CODE = 'EmailMergeCode01'),''))) + ' ' +
