...
set @body =     ((convert(nvarchar(max),isnull((select top 1 CONTROL_CONTENT from tbl_control_text_lang where CONTROL_CODE = 'OrderReturnConfirmEmail.vb' and TEXT_CODE = 'EmailMergeCode01'),''))) + ' ' +
...
set @control_code = 'OrderReturnConfirmEmail.vb'
