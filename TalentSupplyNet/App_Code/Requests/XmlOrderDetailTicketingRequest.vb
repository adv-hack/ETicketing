...
Namespace Talent.TradingPortal
    ...
    Public Class XmlOrderDetailTicketingRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlOrderDetailTicketingResponse = CType(xmlResp, XmlOrderDetailTicketingResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//OrderDetailTicketingRequest").ChildNodes
                            ...
                            With De
                                ...
                                For Each Node2 In Node1.ChildNodes
                                    Select Case Node2.Name
                                        ...
                                        Case Is = "UnprintedRecords"
                                            .UnprintedRecords = Node2.InnerText
                                        Case Is = "SetAsPrinted"
                                            .SetAsPrinted = Node2.InnerText
                                    End Select
