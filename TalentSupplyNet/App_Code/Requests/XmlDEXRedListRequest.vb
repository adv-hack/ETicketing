...
Namespace Talent.TradingPortal
    ...
    Public Class XmlDEXRedListRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            Dim xmlAction As XmlDEXRedListResponse = CType(xmlResp, XmlDEXRedListResponse)
            ...
            Select Case MyBase.DocumentVersion
                ...
                Case Else
                    ...
                    With err
                        ...
                        .ErrorStatus = "DEXRedListRequest Error - Invalid Doc Version " & MyBase.DocumentVersion
                        .ErrorNumber = "DEXRED-02"
                        .HasError = True
                    End With
            End Select
            ...
            If err.HasError Then
                xmlResp.Err = err
            Else
                smartCardProperties.DEXListMode = "R"
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//DEXRedListRequest").ChildNodes
