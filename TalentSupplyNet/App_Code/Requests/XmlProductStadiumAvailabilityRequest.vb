...
Namespace Talent.TradingPortal
    ...
    Public Class XmlProductStadiumAvailabilityRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlProductStadiumAvailabilityResponse = CType(xmlResp, XmlProductStadiumAvailabilityResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//ProductStadiumAvailabilityRequest").ChildNodes
                            ...
                            With DeProductDetails
                                For Each Node2 In Node1.ChildNodes
                                    Select Case Node2.Name
                                        Case Is = "CapacityByStadium"
                                            Dim capacityByStadium As String = Node2.InnerText
                                            If capacityByStadium.ToUpper = "Y" Or capacityByStadium.ToUpper = "TRUE" Then
                                                .CapacityByStadium = True
                                            Else
                                                .CapacityByStadium = False
                                            End If
                                        Case Is = "ProductCode"
