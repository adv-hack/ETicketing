...
Namespace Talent.TradingPortal
    ...
    Public Class XmlRetreivePurchaseHistoryRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlRetreivePurchaseHistoryResponse = CType(xmlResp, XmlRetreivePurchaseHistoryResponse)
            ...
            'Settings.AccountNo1 = "000000000001"
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//RetreivePurchaseHistoryRequest").ChildNodes
