...
'
'       Function                    This class is used to deal with Add Ticketing Reserved Items
'
'       Date                        28/04/2008
'
'       Author                      Ben Ford     
...
'
'       Error Number Code base      TTPRQATRI- 
'                                    
...
Namespace Talent.TradingPortal
    ...
    Public Class XmlAddTicketingReservedItemsRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlAddTicketingReservedItemsResponse = CType(xmlResp, XmlAddTicketingReservedItemsResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//AddTicketingReservedItemsRequest").ChildNodes
