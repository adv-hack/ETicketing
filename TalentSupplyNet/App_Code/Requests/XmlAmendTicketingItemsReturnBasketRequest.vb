...
Namespace Talent.TradingPortal
    ...
    Public Class XmlAmendTicketingItemsReturnBasketRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlAmendTicketingItemsReturnBasketResponse = CType(xmlResp, XmlAmendTicketingItemsReturnBasketResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//AmendTicketingItemsReturnBasketRequest").ChildNodes
