...
Namespace Talent.TradingPortal
    ...
    Public Class XmlProductSeatAvailabilityRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlProductSeatAvailabilityResponse = CType(xmlResp, XmlProductSeatAvailabilityResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//ProductSeatAvailabilityRequest").ChildNodes
