...
Namespace Talent.TradingPortal
    ...
    Public Class XmlRemoveTicketingItemsReturnBasketRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            ...
            Dim xmlAction As XmlRemoveTicketingItemsReturnBasketResponse = CType(xmlResp, XmlRemoveTicketingItemsReturnBasketResponse)
            ...
            If Not err.HasError Then
                ...
                With BASKET
                    .Settings = Settings
                    .De = Deres
                    err = .RemoveTicketingItemsReturnBasket
                End With
                'If Not err.HasError Then
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//RemoveTicketingItemsReturnBasketRequest").ChildNodes
            ...
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//RemoveTicketingItemsReturnBasketRequest").ChildNodes
                    Select Case Node1.Name
                        ...
                        Case Is = "RemoveTicketingItemsReturnBasket"
