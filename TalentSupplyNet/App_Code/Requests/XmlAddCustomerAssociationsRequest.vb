...
Namespace Talent.TradingPortal
    ...
    Public Class XmlAddCustomerAssociationsRequest
        Inherits XmlRequest
        ...
        Public Overrides Function AccessDatabase(ByVal xmlResp As XmlResponse) As XmlResponse
            Dim xmlAction As XmlAddCustomerAssociationsResponse = CType(xmlResp, XmlAddCustomerAssociationsResponse)
        ...
        Private Function LoadXmlV1() As ErrorObj
            ...
            '
            Try
                For Each Node1 In xmlDoc.SelectSingleNode("//AddCustomerAssociationsRequest").ChildNodes
                    Select Case Node1.Name
                        Case Is = "TransactionHeader"

                        Case Is = "CustomerAssociationAdd"
                            For Each Node2 In Node1.ChildNodes
                                Select Case Node2.Name
                                    ...
                                    Case Is = "FriendsAndFamilyMode"
                                        Decust.FriendsAndFamilyMode = Node2.InnerText
                                    Case Is = "Surname"
