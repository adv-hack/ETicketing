...
'
'       Function                    This class is used to deal with update customer responses
'
'       Date                        13/02/09
'
'       Author                       
...
'
'       Error Number Code base      TTPRSCU- 
'                                    
...
Namespace Talent.TradingPortal
    ...
    Public Class XmlCustomerUpdateResponse
        ...
        Protected Overrides Sub InsertBodyV1()
            ...
            Try
                ...
                With MyBase.xmlDoc
                    ndCustomerInfo = .CreateElement("CustomerUpdateDetails")
        ...
        Protected Function PopulateCustomerDetails_SQL2005() As XmlNode
            Dim ndCustomerUpdateDetails As XmlNode, _
            ...
            With MyBase.xmlDoc
                ndCustomerUpdateDetails = .CreateElement("CustomerUpdateDetails")
            ...
            Return ndCustomerUpdateDetails
        End Function
        ...
        Protected Function PopulateCustomerDetails_TALENTTKT() As XmlNode
            ...
            If Not errorOccurred Then
                ...
                For Each dr As DataRow In dtCustomerDetails.Rows
