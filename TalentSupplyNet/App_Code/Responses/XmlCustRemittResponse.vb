...
'
'       Function                    This class is used to deal with Customer Remittance responses
'
'       Date                         Apr 2007
'
'       Author                       
...
Namespace Talent.TradingPortal
    ...
    Public Class XmlCustRemittResponse
        ...
        Protected Overrides Sub InsertBodyV1()
            ...
            Try
                With MyBase.xmlDoc
                    ndEcrmInputs = .CreateElement("CustomerRemittanceRequest")
                    '---------------------------------------------------------------------------------
