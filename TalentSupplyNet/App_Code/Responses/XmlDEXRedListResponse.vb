...
Namespace Talent.TradingPortal
    ...
    Public Class XmlDEXRedListResponse
        ...
        Private dtRedList As New DataTable
        ...
        Protected Overrides Sub InsertHeaderV1()
            ...
            With xmlDoc
                ...
                ndRoot = .CreateElement("RedList")
                atClearList = xmlDoc.CreateAttribute("clearList")
                atClearList.Value = "true"
                ndRoot.Attributes.Append(atClearList)
        ...
        Protected Sub CreateRedList()
            Dim dr As DataRow = Nothing
            If Not Err.HasError Then
                dtRedList = ResultDataSet.Tables(1)

                For Each dr In dtRedList.Rows
                    With xmlDoc
                        ndRedListEntry = .CreateElement("RedListEntry")
