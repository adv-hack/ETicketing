...
Namespace Talent.TradingPortal
    ...
    Public Class XmlProductSeatNumbersResponse
        Inherits XmlResponse

        Private ndHeaderRoot, ndHeaderRootHeader, ndHeader As XmlNode
        Private ndProductList, ndResponse, ndRows, ndErrorOccurred, ndReturnCode As XmlNode
        Private ndRow As XmlNode
        Private atRowName, atRowSeatNumbers As XmlAttribute
            ...
            If Not errorOccurred Then
                ...
                For Each dr In dtProductListDetails.Rows
                    ...
                    With MyBase.xmlDoc
                        ...
                        atRowSeatNumbers = .CreateAttribute("RowSeatNumbers")
                    End With

                    'Populate the nodes
                    atRowName.Value = dr("RowName")
                    atRowSeatNumbers.Value = dr("RowSeatNumbers")

                    'Add Attributes to Row Element
                    ndRow.Attributes.Append(atRowName)
                    ndRow.Attributes.Append(atRowSeatNumbers)
