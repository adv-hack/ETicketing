...
Namespace Talent.TradingPortal
    ...
    Public Class XmlRemoveTicketingItemsResponse
        ...
        Protected Overrides Sub InsertBodyV1()
            ...
            Try
                ...
                With MyBase.xmlDoc
                    ndRemoveTicketingItems = .CreateElement("RemoveTicketingItems")
        ...
        Protected Sub CreateResponseSection()
            ...
            dtStatusDetails2 = ResultDataSet.Tables(3)
            dr2 = dtStatusDetails2.Rows(0)
