...
'
'       Error Number Code base      TTPWSRE- 
'                                    
...
Public Class Returns
    ...
    <WebMethod()> _
    Public Function RMAStatusRequest(ByVal loginId As String, _
                                    ByVal password As String, _
                                    ByVal company As String, _
                                    ByVal XMLString As String) As String
        Dim csgWS As New TalentWebService
        Const a1 As String = "RMAStatusRequest"
        Const a2 As String = "RMAStatusResponse"
        '
