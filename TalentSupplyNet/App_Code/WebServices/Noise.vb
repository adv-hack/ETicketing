...
Public Class Noise
    ...
    <WebMethod()> _
    Public Function RemoveExpiredNoiseSessions(ByVal loginId As String, _
                                              ByVal password As String, _
                                              ByVal company As String, _
                                              ByVal XMLString As String) As String
        Dim csgWS As New TalentWebService
        Const a1 As String = "RemoveExpiredNoiseSessionsRequest"
        Const a2 As String = "RemoveExpiredNoiseSessionsResponse"
        '
