...
'
'       Function                    CreditNote Webservice
'
'       Date                        Nov 2006
'
'       Author                       
...
Public Class CreditNote
    ...
    <WebMethod()> _
    Public Function CreditNoteRequest(ByVal loginId As String, _
                                    ByVal password As String, _
                                    ByVal company As String, _
                                    ByVal XMLString As String) As String
        Dim csgWS As New TalentWebService
        Const a1 As String = "CreditNoteRequest"
        Const a2 As String = "CreditNoteResponse"
        '
