<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" CodeFile="productAway.aspx.vb" Inherits="PagesPublic_productAway" ViewStateMode="Disabled"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Talent:ProductDetail ID="ProductDetail1" runat="server"   ProductType="A" />
