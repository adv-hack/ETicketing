<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" CodeFile="productMembership.aspx.vb" Inherits="PagesPublic_productMembership" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <Talent:ProductDetail ID="ProductDetail1" runat="server"  ProductType='C' />
