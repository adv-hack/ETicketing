<%@ Control Language="VB" AutoEventWireup="false" CodeFile="registrationForm.ascx.vb" Inherits="UserControls_RegistrationForm" %>
<%@ Register Src="~/UserControls/AddressFormat1Form.ascx" TagName="AddressFormat1Form" TagPrefix="Talent" %>

<asp:Label ID="ErrorLabel" runat="server" CssClass="alert-box alert" />
...
<asp:PlaceHolder ID="plhRegistrationTypeBox" runat="server">
<div class="panel ebiz-registration-type">
    <h2><asp:Literal ID="RegistrationTypeHeaderLabel" runat="server" /></h2>
    <div class="row">
        <div class="large-3 columns">
            <asp:Label ID="registrationTypeLabel" runat="server" AssociatedControlID="ddlRegistrationType" />
        </div>
        <div class="large-9 columns">
            <asp:DropDownList ID="ddlRegistrationType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlRegistrationType_SelectedIndexChanged" />
        </div>
    </div>
</div>
</asp:PlaceHolder>
...
<div class="panel ebiz-personal-details">
    ...
    <div class="row ebiz-title">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RegularExpressionValidator ControlToValidate="title" ID="titleRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
    ...
    <div class="row ebiz-first-name">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="forename" ID="forenameRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="forename" ID="forenameRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-initials">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="initials" ID="initialsRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="initials" ID="initialsRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-last-name">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="surname" ID="surnameRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="surname" ID="surnameRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-customersuffix">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="customersuffix" ID="customersuffixRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="customersuffix" ID="customersuffixRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-nickname">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="nickname" ID="nicknameRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="nickname" ID="nicknameRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-altusername">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="altusername" ID="altusernameRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="altusername" ID="altusernameRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
              <asp:PlaceHolder ID="plhContactSL" runat="server">
    <div class="row ebiz-contactsl">
        <div class="medium-3 columns">
            <asp:Label ID="contactslLabel" runat="server" AssociatedControlID="contactsl" />
        </div>
        <div class="medium-9 columns">
            <asp:TextBox ID="contactsl" runat="server" />
            <asp:RequiredFieldValidator ControlToValidate="contactsl" ID="contactslRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="contactsl" ID="contactslRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-salutation">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="salutation" ID="salutationRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="salutation" ID="salutationRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-company">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="txtCompanyName" ID="companyNameRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="txtCompanyName" ID="companyNameRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-position">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="position" ID="positionRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="position" ID="positionRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-dob">
        ...
        <div class="medium-3 columns ebiz-dob-day">
            ...
            <asp:RegularExpressionValidator ControlToValidate="dobDay" ID="dobDayRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
        <div class="medium-3 columns ebiz-dob-month">
            ...
            <asp:RegularExpressionValidator ControlToValidate="dobMonth" ID="dobMonthRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
        <div class="medium-3 columns ebiz-dob-year">
            ...
            <asp:RegularExpressionValidator ControlToValidate="dobYear" ID="dobYearRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-sex">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RegularExpressionValidator ControlToValidate="sex" ID="sexRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-email ebiz-contact-preference">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="email" ID="emailRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="email" ID="emailRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    ...
    <asp:PlaceHolder ID="plhEmailCompare" runat="server" Visible="True">
        <div class="row ebiz-confirm-email">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="emailConfirm" ID="emailConfirmRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:CompareValidator ID="emailConfirmCompare" runat="server" OnInit="SetupCompareValidator" ControlToValidate="emailConfirm" ControlToCompare="email" SetFocusOnError="true"
                    Visible="true" ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-home-number ebiz-contact-preference">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="phone" ID="phoneRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="phone" ID="phoneRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
        <div class="medium-9 large-offset-3 columns">
    ...
    <div class="row ebiz-work-number ebiz-contact-preference">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="work" ID="workRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="work" ID="workRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
        <div class="medium-9 large-offset-3 columns">
    ...
    <div class="row ebiz-mobile-number ebiz-contact-preference">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="mobile" ID="mobileRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="mobile" ID="mobileRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
        <div class="medium-9 large-offset-3 columns">
    ...
    <div class="row ebiz-fax-number">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="fax" ID="faxRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="fax" ID="faxRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-agent-only-other">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="other" ID="otherRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="other" ID="otherRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
...
<asp:PlaceHolder ID="plhCredential" runat="server" Visible="True">
    <div class="panel ebiz-credentials">
        <asp:PlaceHolder ID="CredentialsBoxTitle" runat="server">
            <h2><asp:Literal ID="CredentialsLabel" runat="server" /></h2>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="PasswordInstructionsRow" runat="server">
            <p class="ebiz-password-instructions"><asp:Literal ID="passwordInstructionsLabel" runat="server" /></p>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="plhUserName" runat="server">
        <div class="row ebiz-username">
            <div class="medium-3 columns">
                <asp:Label ID="loginIDLabel" runat="server" AssociatedControlID="loginid" />
            </div>
            <div class="medium-9 columns">
        ...
        <asp:PlaceHolder ID="plhPassword1Row" runat="server">
        <div class="row ebiz-password">
            <div class="medium-3 columns">
                <asp:Label ID="password1Label" runat="server" AssociatedControlID="password1" />
            </div>
            <div class="medium-9 columns">
                <asp:TextBox ID="password1" runat="server" TextMode="Password" />
                <asp:RequiredFieldValidator ControlToValidate="password1" ID="password1RFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="password1" ID="password1RegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="plhPassword2Row" runat="server">
        <div class="row ebiz-confirm-password">
            <div class="medium-3 columns">
                <asp:Label ID="password2Label" runat="server" AssociatedControlID="password2" />
            </div>
            <div class="medium-9 columns">
                <asp:TextBox ID="password2" runat="server" TextMode="Password" />
                <asp:RequiredFieldValidator ControlToValidate="password2" ID="password2RFV" runat="server" SetFocusOnError="true" Visible="true" ValidationGroup="Registration" Display="Static"
                    Enabled="true" CssClass="error ebiz-validator-error" OnInit="SetupRequiredValidator" />
                <asp:CompareValidator ID="passwordCompare" runat="server" OnInit="SetupCompareValidator" ControlToValidate="password2" ControlToCompare="password1" SetFocusOnError="true"
                    Visible="true" ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
...
<div class="panel ebiz-address-information">
    <asp:PlaceHolder ID="plhAddressTitleRow" runat="server">
        <h2><asp:Literal ID="AddressInfoLabel" runat="server" /></h2>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-type">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="type" ID="typeRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="type" ID="typeRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-reference">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="reference" ID="referenceRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="reference" ID="referenceRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    <asp:PlaceHolder ID="AddressSequenceRow" runat="server">
    <div class="row ebiz-address-sequence">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="sequence" ID="sequenceRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="sequence" ID="sequenceRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-building">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="building" ID="buildingRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="building" ID="buildingRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-street">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="street" ID="streetRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="street" ID="streetRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-town">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="town" ID="townRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="town" ID="townRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-city">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="city" ID="cityRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="city" ID="cityRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-county">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="county" ID="countyRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="county" ID="countyRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-postcode">
        ...
        <div class="medium-9 columns">
            ...
            <asp:RequiredFieldValidator ControlToValidate="postcode" ID="postcodeRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            <asp:RegularExpressionValidator ControlToValidate="postcode" ID="postcodeRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
    ...
    <div class="row ebiz-address-country">
        ...
        <div class="medium-9 columns">
            <asp:DropDownList ID="country" runat="server" CssClass="select2" />
            <asp:RegularExpressionValidator ControlToValidate="country" ID="countryRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
        </div>
    </div>
    </asp:PlaceHolder>
...
<div class="panel ebiz-contact">
    <asp:Repeater ID="contactRepeater" runat="server">
        <HeaderTemplate>
            <h2><asp:Literal ID="TeamContactHeaderLabel" runat="server" /></h2>
        </HeaderTemplate>
        <ItemTemplate>
            <div class="row">
                <div class="medium-3 columns">
...
<asp:Placeholder ID="plhContactPreferences" runat="server">
    <div class="panel ebiz-contact-preferences">
        <h2><asp:Literal ID="ltlContactPrefsH2" runat="server" /></h2>
        ...
        <!--
        <p>--------------------------------------------------------<br />Start mark-up mock-up for GDPR<br />--------------------------------------------------------</p>
        
        <div class="row">
          <div class="column">
            <fieldset class="js-no-icheck o-radio-group-faux-buttons o-radio-group-faux-buttons--gdpr">
              <legend>Can we spam your email address&hellip;?</legend>
              <input type="radio" name="gdpr1" value="no" id="gdpr1no" class="o-radio-group-faux-buttons__radio">
              <label for="gdpr1no" class="o-radio-group-faux-buttons__label o-radio-group-faux-buttons__opt-out">No</label>
              <input type="radio" name="gdpr1" value="yes" id="gdpr1yes" class="o-radio-group-faux-buttons__radio">
              <label for="gdpr1yes" class="o-radio-group-faux-buttons__label o-radio-group-faux-buttons__opt-in">Yes</label>
            </fieldset>
          </div>
        </div>
      ...
      <div class="row">
        <div class="column">
          <fieldset class="js-no-icheck o-radio-group-faux-buttons">
            <legend>Do you want nuisance calls&hellip;?</legend>
            <input type="radio" name="gdpr2" value="no" id="gdpr2no" class="o-radio-group-faux-buttons__radio">
            <label for="gdpr2no" class="o-radio-group-faux-buttons__label o-radio-group-faux-buttons__opt-out">No</label>
            <input type="radio" name="gdpr2" value="yes" id="gdpr2yes" class="o-radio-group-faux-buttons__radio">
            <label for="gdpr2yes" class="o-radio-group-faux-buttons__label o-radio-group-faux-buttons__opt-in">Yes</label>
          </fieldset>
        </div>
      </div>
      ...
      <div class="row">
        <div class="column">
            <input type="checkbox" id="gdpr3" />
            <label for="gdpr3">Do not the bother me&hellip;!</label>
        </div>
      </div>

      <div class="row">
        <div class="column">
            <input type="checkbox" id="gdpr4" />
            <label for="gdpr4">Call me may be&hellip;?</label>
        </div>
      </div>
      ...
      <div class="row">
        <div class="column">
            <fieldset>
              <legend>I want to receive&hellip;</legend>
              <div class="row">
                <div class="column">
                    <input type="checkbox" id="gdpr5" />
                    <label for="gdpr5">Emails</label>
                  </div>
                </div>
              <div class="row">
                <div class="column">
                    <input type="checkbox" id="gdpr6" />
                    <label for="gdpr6">Faxes</label>
                  </div>
              </div>
              <div class="row">
               <div class="column">
                  <input type="checkbox" id="gdpr7" />
                  <label for="gdpr7">Phone calls</label>
                </div>
              </div>
            </fieldset>
        </div>
      ...
      <p>--------------------------------------------------------<br />End mark-up mock-up for GDPR<br />--------------------------------------------------------</p>
      -->
...
<asp:PlaceHolder ID="plhRegisteredAddress" runat="server">
    <div class="panel ebiz-delivery-address">
        <h2><asp:Literal ID="ltlRegAddressHdr" runat="server" /></h2>
        <div class="row ebiz-registration-address-same">
            <div class="large-12 columns"><asp:CheckBox ID="chkRegAddressSame" runat="server" AutoPostBack="True" /></div>
        </div>
        ...
        <div class="row ebiz-address-line-one">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegAddress1" ID="rfvTxtRegAddress1" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegAddress1" ID="regexTxtRegAddress1" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        ...
        <div class="row ebiz-address-line-two">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegAddress2" ID="rfvTxtRegAddress2" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegAddress2" ID="regexTxtRegAddress2" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        ...
        <div class="row ebiz-address-line-three">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegAddress3" ID="rfvTxtRegAddress3" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegAddress3" ID="regexTxtRegAddress3" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="RegAddressLine4Row" runat="server">
        <div class="row ebiz-address-line-four">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegAddress4" ID="rfvTxtRegAddress4" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegAddress4" ID="regexTxtRegAddress4" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        ...
        <div class="row ebiz-address-line-five">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegAddress5" ID="rfvTxtRegAddress5" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegAddress5" ID="regexTxtRegAddress5" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        ...
        <div class="row ebiz-postcode">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="txtRegPostcode" ID="rfvTxtRegPostcode" runat="server" OnInit="SetupRegRequiredValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
                <asp:RegularExpressionValidator ControlToValidate="txtRegPostcode" ID="regexTxtRegPostcode" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
        ...
        <div class="row ebiz-country">
            ...
            <div class="medium-9 columns">
                ...
                <asp:RegularExpressionValidator ControlToValidate="ddlRegCountry" ID="regexDdlRegCountry" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true"
                    ValidationGroup="Registration" Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        </asp:PlaceHolder>
...
<asp:PlaceHolder ID="plhUserIDs" runat="server" Visible="false">
    <div class="panel ebiz-user-id">
        <h2><asp:Literal ID="ltlUserIDsHeaderLabel" runat="server" /></h2>
        <asp:PlaceHolder ID="plhPassport" runat="server">
        <div class="row ebiz-passport">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhGreencard" runat="server">
        <div class="row ebiz-green-card">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhPin" runat="server">
        ...
        <asp:PlaceHolder ID="plhUserID4" runat="server">
        <div class="row ebiz-id-four">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhUserID5" runat="server">
        <div class="row ebiz-id-five">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhUserID6" runat="server">
        <div class="row ebiz-id-six">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhUserID7" runat="server">
        <div class="row ebiz-id-seven">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhUserID8" runat="server">
        <div class="row ebiz-id-eight">
            <div class="medium-3 columns">
        ...
        <asp:PlaceHolder ID="plhUserID9" runat="server">
        <div class="row ebiz-id-nine">
            <div class="medium-3 columns">
...
<div class="js--show-parental-consent" runat="server" id="showparentalconsent" style=" display: none; ">
    <div class="panel ebiz-parent-consent">
        <h2>
            <asp:Literal ID="NeedAdultConsentForContactPermissionsHeading" runat="server" /></h2>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="large-3 columns">
                ...
                <asp:RequiredFieldValidator ControlToValidate="parentemail" ID="parentemailRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"  Display="Static" Enabled="true" Text="" CssClass="error ebiz-validator-error" class="js--Parents-Email-RFV"/>
                <asp:RegularExpressionValidator ControlToValidate="parentemail" ID="parentemailRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                    Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
        <div class="row">
            ...
            <div class="large-3 columns">
              ...
              <asp:RequiredFieldValidator ControlToValidate="parentphone" ID="parentphoneRFV" runat="server" OnInit="SetupRequiredValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"  Display="Static" Enabled="true" Text="" CssClass="error ebiz-validator-error" class="js--Parents-Phone-RFV"/>
                  <asp:RegularExpressionValidator ControlToValidate="parentphone" ID="parentphoneRegEx" runat="server" OnLoad="SetupRegExValidator" SetFocusOnError="true" Visible="true" ValidationGroup="Registration"
                    Display="Static" Enabled="true" CssClass="error ebiz-validator-error" />
            </div>
        </div>
    </div>
...
<asp:PlaceHolder ID="plhTandCs" runat="server" Visible="True">
    <div class="ebiz-terms-and-conditions">
        <asp:CheckBox ID="TandCs" runat="server" />
    </div>
</asp:PlaceHolder>

<div class="panel ebiz-confirm-email" id="isConfirmationEmailSend" runat="server">
<asp:PlaceHolder ID="plhIsConfirmationEmailSend" runat="server">
    <div class="ebiz-mail-option">
        <asp:CheckBox ID="cbIsConfirmationEmailSend" runat="server" />
        <asp:Label ID="IsConfirmationEmailLabel" runat="server" AssociatedControlID="cbIsConfirmationEmailSend" />
    </div>
</asp:PlaceHolder>
</div>
<div class="ebiz-reister">
    <asp:Button ID="registerBtn" CssClass="button" runat="server" CausesValidation="true" ValidationGroup="Registration" />
</div>
<%  WriteDDLJavascript()%>