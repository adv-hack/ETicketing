<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CreditNoteEnquiry.ascx.vb"
    Inherits="UserControls_CreditNoteEnquiry" %>
...
<div id="order-enquiry">
    ...
    <div>
        ...
        <asp:Button ID="FromDateLinkButton" runat="server" CssClass="button"></asp:Button>
    </div>
    <div>
        ...
        <asp:Button ID="ToDateLinkButton" runat="server" CssClass="button"></asp:Button>
    </div>
...
<div id="invoice-enquiry-matrix">
    <asp:Repeater ID="CreditNoteHistoryView" runat="Server">
            ...
            <table cellspacing="0" summary="Invoice history">
                <tr>
                    ...
                    <th class="order-no" scope="col">
                        <asp:Label ID="CompanyRefHeader" runat="server" OnPreRender="GetText"> </asp:Label></th>
                    ...
                    <th class="invoice-value" scope="col">
                        <asp:Label ID="CreditNoHeader" runat="server" OnPreRender="GetText"></asp:Label></th>
                    <th class="outstanding-value" scope="col">
                        <asp:Label ID="CreditDateHeader" runat="server" OnPreRender="GetText"></asp:Label></th>
        ...
        <ItemTemplate>
            <tr>
                <td class="invoice-no">
                    <asp:Label ID="CreditNoteID" runat="server" Text='<%# Container.DataItem("CreditNoteNumber") %>'></asp:Label></td>
                <td class="order-no">
                    <asp:Label ID="OrderID" runat="server" Text='<%# Container.DataItem("OrderNumber") %>'></asp:Label></td>
                <td class="invoice-date">
                    <asp:Label ID="CreditNoteDate" runat="server" Text='<%# Container.DataItem("CreditNoteDateTime") %>'></asp:Label></td>
                ...
                <td class="invoice-value">
                    <asp:Label ID="CreditNoteValue" runat="server" Text='<%# FormatCurrency(Talent.eCommerce.Utilities.RoundToValue(Container.DataItem("CreditNoteAmount"), 0.01, False))%>'></asp:Label></td>
                ...
                <td class="action">
                    <asp:HyperLink ID="ViewDetailsLink" runat="server" OnLoad="GetText" OnPreRender="OpenCreditNoteDetails"></asp:HyperLink></td>                
