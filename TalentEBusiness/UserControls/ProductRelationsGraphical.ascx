<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ProductRelationsGraphical.ascx.vb" Inherits="UserControls_ProductRelationsGraphical" %>
<asp:Panel ID="pnlProductRelationsGraphical" runat="server">
    <div class="ProductRelationsGraphical_ascx product-relations-graphical graphical-product-list">
        ...
        <div>
            ...
            <br />
            <asp:PlaceHolder ID="plhShowErrors" runat="server" Visible="false">
