...
Namespace com.qas.prowebondemand
    ...
    Public Class LicensedSet
        ...
        Public Shared Function createArray(info As QADataMapDetail) As LicensedSet()
            Dim aResults As LicensedSet() = Nothing
            Dim aInfo As QALicensedSet() = info.LicensedSet

            If aInfo IsNot Nothing Then
                If aInfo.Length > 0 Then
                    aResults = New LicensedSet(aInfo.Length - 1) {}
