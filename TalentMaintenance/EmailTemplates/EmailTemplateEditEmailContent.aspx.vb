...
Partial Class EmailTemplates_EmailTemplateEditEmailContent
...
#Region "Protected Methods"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        With (_wfrPage)
            ...
            .KeyCode = "EmailTemplateEditEmailContent.aspx" 'Talent.eCommerce.Utilities.GetCurrentPageName
            .PageCode = "EmailTemplateEditEmailContent.aspx" 'Talent.eCommerce.Utilities.GetCurrentPageName
        End With
    End Sub
