...
Partial Class EmailTemplates_EmailTemplateSendTestEmail
...
#Region "Protected Methods"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        With (_wfrPage)
            ...
            .KeyCode = "emailTemplateSendTestEmail.aspx" 'Talent.eCommerce.Utilities.GetCurrentPageName
            .PageCode = "emailTemplateSendTestEmail.aspx" 'Talent.eCommerce.Utilities.GetCurrentPageName
        End With
    End Sub
