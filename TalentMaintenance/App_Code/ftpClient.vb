...
#Region "Properties"
        ...
        Public Property Username() As String
            Get
                Return IIf(_username = "", CObj("anonymous"), CObj(_username)).ToString
            End Get
            Set(ByVal value As String)
                _username = value
            End Set
        ...
        Private _uploadErrorMessage As String
        Public Property UploadErrorMessage() As String
            Get
...
#End Region
        ...
        Sub New(ByVal line As String, ByVal path As String)
            ...
            Else
                ...
                _path = path
                If m.Groups("size").Value <> String.Empty Then
