...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_currency_format_bu based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_currency_format_bu
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_currency_format_bu"
#End Region
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_currency_format_bu" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        ''' <summary>
        ''' Gets all the business unit records from the table tbl_currency_format_bu
        ''' </summary>
        ...
        Public Function GetAll(Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From TBL_CURRENCY_FORMAT_BU"
        ...
        Public Function GetByBU(ByVal businessUnit As String, Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteDataSet
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From TBL_CURRENCY_FORMAT_BU Where BUSINESS_UNIT=@BusinessUnitName"
        ...
        ''' <summary>
        ''' Gets the business unit records based on the given business unit and currency code
        ''' </summary>
        ''' <param name="businessUnit">The business unit.</param>
        ...
        ''' <param name="cacheTimeMinutes">The cache time minutes. Default <c>30</c></param>
        ''' <returns>DataTable</returns>
        Public Function GetByBUAndCurrencyCode(ByVal businessUnit As String, ByVal currencyCode As String, Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            Dim outputDataTable As New DataTable
            Dim cacheKeyPrefix As String = GetCacheKeyPrefix(CACHEKEY_CLASSNAME, "GetByBUAndCurrencyCode")
            Dim talentSqlAccessDetail As New TalentDataAccess
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.Cacheing = cacheing
                talentSqlAccessDetail.Settings.CacheTimeMinutes = cacheTimeMinutes
                talentSqlAccessDetail.Settings.CacheStringExtension = cacheKeyPrefix & ToUpper(businessUnit) & ToUpper(currencyCode)
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteDataSet
                talentSqlAccessDetail.CommandElements.CommandText = "SELECT * FROM TBL_CURRENCY_FORMAT_BU WHERE BUSINESS_UNIT = @BusinessUnit AND CURRENCY_CODE = @CurrencyCode"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_CURRENCY_FORMAT_BU " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_currency_format_bu
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            talentSqlAccessDetail.Settings.CacheStringExtension = ""
            talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
            Dim sqlStatement As String = "INSERT INTO TBL_CURRENCY_FORMAT_BU (BUSINESS_UNIT, CURRENCY_CODE, FORMAT_STRING, " & _
                        "RULE_TYPE)" & _
                        "SELECT @ToBusinessUnit As BUSINESS_UNIT, CURRENCY_CODE, FORMAT_STRING, " & _
                        "RULE_TYPE FROM TBL_CURRENCY_FORMAT_BU " & _
