...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_chip_and_pin_devices based on business functionality
    ''' </summary>
    <Serializable()> _
    Public Class tbl_chip_and_pin_devices
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_chip_and_pin_devices"
#End Region
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_chip_and_pin_devices" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function GetByBUPartner(ByVal businessUnit As String, ByVal partner As String, Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                Dim sqlStatement As String = "SELECT * FROM [tbl_chip_and_pin_devices] WHERE "
