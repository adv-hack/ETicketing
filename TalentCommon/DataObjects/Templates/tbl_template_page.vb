...
Namespace DataObjects.TableObjects
    ...
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_template_page based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_template_page
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_template_page" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_TEMPLATE_PAGE " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_template_page
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO TBL_TEMPLATE_PAGE (" & _
                    "BUSINESS_UNIT, PAGE_NAME, PARTNER, TEMPLATE_NAME) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, PAGE_NAME, PARTNER, TEMPLATE_NAME " & _
                    "FROM TBL_TEMPLATE_PAGE " & _
