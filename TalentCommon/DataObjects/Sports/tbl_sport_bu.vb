...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data for the table tbl_sport_bu based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_sport_bu
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_sport_bu"
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_sport_bu" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        ''' <summary>
        ''' Gets all the records from the table tbl_sport_bu
        ''' </summary>
        ...
        Public Function GetAll(Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From tbl_sport_bu"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE tbl_sport_bu " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_sport_bu
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO tbl_sport_bu (" & _
                    "BUSINESS_UNIT, PARTNER, SPORT_CODE) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, PARTNER, SPORT_CODE " & _
                    "FROM tbl_sport_bu " & _
