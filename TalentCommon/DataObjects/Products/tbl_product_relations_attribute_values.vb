...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_product_relations_attribute_values
    ''' </summary>
    <Serializable()> _
    Public Class tbl_product_relations_attribute_values
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_product_relations_attribute_values"
#End Region
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_product_relations_attribute_values" /> class.
        ''' </summary>
...
#Region "Public Functions"
        ...
        ''' <summary>
        ''' Get tbl_product_relations_attribute_values data by Business Unit, Partner, Qualifier, Page Code, Page Position and Template Type
        ''' </summary>
        ...
        ''' <param name="pagePosition">The given page position</param>
        ...
        ''' <remarks></remarks>
        Public Function GetProductRelationsAttributes(ByVal businessUnit As String, ByVal partner As String, ByVal pageCode As String,
                                                      ByVal qualifier As String, ByVal pagePosition As String, ByVal templateType As String, _
                                                      Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            Dim outputDataTable As New DataTable
            Dim cacheKeyPrefix As String = GetCacheKeyPrefix(CACHEKEY_CLASSNAME, "GetProductRelationsAttributes")
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandParameter.Add(ConstructParameter("@PagePosition", pagePosition))
                talentSqlAccessDetail.CommandElements.CommandParameter.Add(ConstructParameter("@TemplateType", templateType))

                Dim sqlStatement As String = "SELECT * FROM [tbl_product_relations_attribute_values] WHERE QUALIFIER=@Qualifier AND PAGE_POSITION=@PagePosition AND TEMPLATE_TYPE=@TemplateType AND "
