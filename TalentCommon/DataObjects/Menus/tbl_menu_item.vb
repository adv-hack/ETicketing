...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_menu_item based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_menu_item
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_menu_item" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_MENU_ITEM " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_menu_item
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO TBL_MENU_ITEM (" & _
                    "BUSINESS_UNIT, PARTNER_CODE, MENU, MENU_ITEM) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, PARTNER_CODE, MENU, MENU_ITEM " & _
                    "FROM TBL_MENU_ITEM " & _
