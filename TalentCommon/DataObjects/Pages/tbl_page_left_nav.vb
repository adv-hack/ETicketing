...
Namespace DataObjects.TableObjects
    ...
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_page_left_nav based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_page_left_nav
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_page_left_nav" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_PAGE_LEFT_NAV " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_page_left_nav
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO TBL_PAGE_LEFT_NAV (" & _
                    "BUSINESS_UNIT, BOTTOM_USER_NAV1, BOTTOM_USER_NAV2, " & _
                    "BOTTOM_USER_NAV3, BOTTOM_USER_NAV4, BOTTOM_USER_NAV5, " & _
                    "MY_ACCOUNT_NAV, PAGE_NAME, PARTNER_CODE, " & _
                    "PRODUCT_NAV, TOP_USER_NAV1) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, BOTTOM_USER_NAV1, BOTTOM_USER_NAV2, " & _
                    "BOTTOM_USER_NAV3, BOTTOM_USER_NAV4, BOTTOM_USER_NAV5, " & _
                    "MY_ACCOUNT_NAV, PAGE_NAME, PARTNER_CODE, " & _
                    "PRODUCT_NAV, TOP_USER_NAV1 " & _
                    "FROM TBL_PAGE_LEFT_NAV " & _
