...
Namespace DataObjects.TableObjects
    ...
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_page_text based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_page_text
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_page_text" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_PAGE_TEXT " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_page_text
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO TBL_PAGE_TEXT (" & _
                    "BUSINESS_UNIT, DESCRIPTION, PAGE_CODE, " & _
                    "PARTNER_CODE, TEXT_CODE) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, DESCRIPTION, PAGE_CODE, " & _
                    "PARTNER_CODE, TEXT_CODE " & _
                    "FROM TBL_PAGE_TEXT " & _
