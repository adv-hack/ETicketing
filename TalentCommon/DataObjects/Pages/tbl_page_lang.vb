...
Namespace DataObjects.TableObjects
    ...
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_page_lang based on business functionality
    ''' </summary>
    <Serializable()> _
        Public Class tbl_page_lang
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_page_lang" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_PAGE_LANG " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_page_lang
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                talentSqlAccessDetail.Settings.CacheStringExtension = ""
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
                Dim sqlStatement As String = "INSERT INTO TBL_PAGE_LANG (" & _
                    "BUSINESS_UNIT, LANGUAGE_CODE, META_DESC, " & _
                    "META_KEY, PAGE_CODE, PAGE_HEADER, " & _
                    "PARTNER_CODE, TITLE) " & _
                    "SELECT " & _
                    "@ToBusinessUnit As BUSINESS_UNIT, LANGUAGE_CODE, META_DESC, " & _
                    "META_KEY, PAGE_CODE, PAGE_HEADER, " & _
                    "PARTNER_CODE, TITLE " & _
                    "FROM TBL_PAGE_LANG " & _
