...
Namespace DataObjects.TableObjects
    ...
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_ebusiness_descriptions_bu based on business functionality
    ''' </summary>
    <Serializable()> _
    Public Class tbl_ebusiness_descriptions_bu
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_ebusiness_descriptions_bu" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_EBUSINESS_DESCRIPTIONS_BU " & _
        ...
        ''' <summary>
        ''' Copies the records from one business unit to another business unit inside the table tbl_ebusiness_descriptions_bu
        ...
        Public Function CopyByBU(ByVal fromBusinessUnit As String, ByVal toBusinessUnit As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Try
                ...
                Dim sqlStatement As String = "INSERT INTO TBL_EBUSINESS_DESCRIPTIONS_BU (BUSINESS_UNIT, QUALIFIER, " & _
                            "PARTNER, DESCRIPTION_TYPE, DESCRIPTION_CODE) " & _
                            "SELECT @ToBusinessUnit As BUSINESS_UNIT, QUALIFIER, PARTNER, DESCRIPTION_TYPE, " & _
                            "DESCRIPTION_CODE FROM TBL_EBUSINESS_DESCRIPTIONS_BU " & _
