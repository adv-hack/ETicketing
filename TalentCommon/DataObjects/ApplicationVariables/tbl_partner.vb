...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_partner based on business functionality
    ''' </summary>
    <Serializable()> _
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_partner"
#End Region
...
#Region "Constructors"
        ...
        End Sub
        ''' <summary>
        ''' Initializes a new instance of the <see cref="tbl_bu" /> class.
        ''' </summary>
...
#Region "Public Methods"
        ...
        ''' <summary>
        ''' Gets all the parter records from the table tbl_partner
        ''' </summary>
        ...
        Public Function GetAll(Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From TBL_PARTNER"
