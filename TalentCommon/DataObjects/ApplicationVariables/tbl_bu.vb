...
Namespace DataObjects.TableObjects
    ''' <summary>
    ''' Provides the functionality to manage data from the table tbl_bu based on business functionality
    ''' </summary>
    <Serializable()> _
    Public Class tbl_bu
...
#Region "Class Level Fields"
        ...
        ''' </summary>
        Const CACHEKEY_CLASSNAME As String = "tbl_bu"
#End Region
...
#Region "Public Methods"
        ...
        ''' <summary>
        ''' Gets all the business unit records from the table tbl_bu
        ''' </summary>
        ...
        Public Function GetAll(Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From TBL_BU"
        ...
        Public Function GetByBU(ByVal businessUnit As String, Optional ByVal cacheing As Boolean = True, Optional ByVal cacheTimeMinutes As Integer = 30) As DataTable
            ...
            Try
                ...
                talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteDataSet
                talentSqlAccessDetail.CommandElements.CommandText = "Select * From TBL_BU Where BUSINESS_UNIT=@BusinessUnitName"
        ...
        Public Function Delete(ByVal businessUnitToDelete As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            Dim sqlStatement As String = "DELETE TBL_BU " & _
        ...
        ''' </summary>
        ''' <param name="businessUnit">The business unit.</param>
        ''' <param name="businessUnitDesc">The description.</param>
        ''' <returns>No Of Affected Rows</returns>
        Public Function Insert(ByVal businessUnit As String, ByVal businessUnitDesc As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
            Dim sqlStatement As String = "INSERT TBL_BU " & _
                "(BUSINESS_UNIT, BUSINESS_UNIT_DESC) VALUES " & _
                "(@BusinessUnit, @BusinessUnitDesc) "
            talentSqlAccessDetail.CommandElements.CommandText = sqlStatement
            talentSqlAccessDetail.CommandElements.CommandParameter.Add(ConstructParameter("@BusinessUnit", businessUnit))
            talentSqlAccessDetail.CommandElements.CommandParameter.Add(ConstructParameter("@BusinessUnitDesc", businessUnitDesc))
        ...
        ''' <param name="businessUnitDesc">The description.</param>
        ''' <returns>No Of Affected Rows</returns>
        Public Function Update(ByVal businessUnit As String, ByVal businessUnitDesc As String, Optional ByVal givenTransaction As SqlTransaction = Nothing) As Integer
            ...
            talentSqlAccessDetail.Settings.Cacheing = False
            talentSqlAccessDetail.CommandElements.CommandExecutionType = CommandExecution.ExecuteNonQuery
            Dim sqlStatement As String = "UPDATE TBL_BU " & _
                " SET (BUSINESS_UNIT_DESC = @BusinessUnitDesc)" & _
