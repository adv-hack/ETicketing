...
Public Class DEOrderReponse
    ...
    Private _currencyCode As String = String.Empty                      ' CURN40
    Private _currencyRate As String = String.Empty                      ' CURT40
    Private _itemsShipped As Boolean = False                            ' 
    Private _totalTax As String = String.Empty
    Private _salePlusTax As String = String.Empty
    Private _grandTotal As String = String.Empty
    ' 
    '---------------------------------------------------------------------------------------------
    '   OrderStatusRequest
    '
    Private _orderCreditMemoCode As String = String.Empty               '  
    Private _orderCreditMemo1 As String = String.Empty                  '  
    Private _orderCreditMemo2 As String = String.Empty                  '                  
    Private _orderStatus As String = String.Empty                       '' STAT40 on OEP40 
    Private _ShippedDate As Date                                        ' Try DSDT56 on INP56
    ...
    Private _distributionWeight As String = String.Empty                ' 
    ...
    Private _billToPostalCode As String = String.Empty
    Private _billToCountry As String = String.Empty
    '-----------------------------------------------------------------------------
    ...
    Public Property CurrencyRate() As String
        ...
        End Set
    End Property
    Public Property ItemsShipped() As Boolean
        Get
            Return _itemsShipped
        End Get
    ...
    Public Property TotalTax() As String
        ...
        End Set
    End Property
    Public Property SalePlusTax() As String
        Get
            Return _salePlusTax
        End Get
        Set(ByVal value As String)
    ...
    '   OrderStatusRequest
    '
    Public Property OrderCreditMemoCode() As String
        Get
            Return _orderCreditMemoCode
        End Get
        Set(ByVal value As String)
            _orderCreditMemoCode = value
        End Set
    End Property
    Public Property OrderCreditMemo1() As String
        Get
            Return _orderCreditMemo1
        End Get
        Set(ByVal value As String)
            _orderCreditMemo1 = value
        End Set
    End Property
    Public Property OrderCreditMemo2() As String
        Get
            Return _orderCreditMemo2
        End Get
        Set(ByVal value As String)
            _orderCreditMemo2 = value
        End Set
    End Property
